...
export enum Permissions {
  ...
  RAFFLE_CONFIGURE = 'raffle:configure',
...
export const PERMISSION_DEFINITIONS: Array<{
  ...
  { slug: Permissions.ORDERS_DELETE, resource: 'orders', action: 'delete' },
  { slug: Permissions.ORDERS_ADD_ITEM, resource: 'orders', action: 'add_item' },
  ...
  { slug: Permissions.RAFFLE_CONFIGURE, resource: 'raffle', action: 'configure' },
